  ...
  <div style="display: flex; justify-content: center">
    <el-card style="min-width: 50%">
      ...
      >
        <img
          alt="Vue logo"
          src="../../assets/logo_random_roll_call.png"
          style="width: 256px"
        />
        ...
        >
          <div style="font-size: 18px; margin-bottom: 16px">
            抽选名单<label style="font-size: 16px; color: deeppink"
              >(多个选项用英文","隔开)</label
            >
          </div>
          <el-input
        ...
        >
          ...
          <el-input
            ...
            :min="1"
            placeholder="请输入抽选数量"
            oninput="(value.trim() === '' || value === '0') ? value = 1 : value = value.replace(/[^0-9]/g,'')"
    ...
    >
      <template #header>
        ...
        >
          ...
          <img
            src="../../assets/salute.png"
            style="width: 48px; height: 48px; transform: rotateY(180deg)"
          />
        </div>
      </template>
      <div style="text-align: center; font-size: 18px">
        恭喜
        <label style="font-size: 30px; color: red">{{
          selectedDatasStr
        }}</label>
        被选中！
      </div>
...
const rawDatas = ref<string>(
  "中森明菜,周慧敏,克莉丝汀·斯图尔特,西野翔,洪真英,张敏,桥本环奈,邱淑贞,奥黛丽·赫本,赵丽颖,星野悠月,布兰妮·斯皮尔斯,邓寓君,飞儿,坂井泉水"
);
